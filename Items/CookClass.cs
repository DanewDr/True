...
namespace CookieMod.Items
{
	...
	public abstract class CookClass : ModItem
	{
		...
		public override void GetWeaponDamage(Player player, ref int damage)
		{
			...
			damage = (int)(damage * CookDamagePlayer.ModPlayer(player).cookDamage + 5E-06f);
		}

		public override void GetWeaponKnockback(Player player, ref float knockback)
		{
			// Adds knockback bonuses
			knockback = knockback + CookDamagePlayer.ModPlayer(player).cookKnockback;
		}

		public override void GetWeaponCrit(Player player, ref int crit)
		{
			// Adds crit bonuses
			crit = crit + CookDamagePlayer.ModPlayer(player).cookCrit;
		}
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			if (tt != null)
			{
				...
				tt.text = damageValue + " culinary " + damageWord;
			}
		}
	}
}
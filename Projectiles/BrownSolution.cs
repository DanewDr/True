...
{
	public class BrownSolution : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Brown Spray");
		}
		...
		{
			int dustType = mod.DustType("BrownSolution");
...
/*						int wall = (int)Main.tile[k, l].wall;
						if (wall != 0)
						{
							Main.tile[k, l].wall = (ushort)mod.WallType("CookieWall");
							WorldGen.SquareWallFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1);
						}*/
						if (TileID.Sets.Conversion.Stone[type])
						{
							Main.tile[k, l].type = (ushort)mod.TileType("Creamstone");
							WorldGen.SquareTileFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1);
						}
						if (TileID.Sets.Conversion.Ice[type])
						{
							Main.tile[k, l].type = (ushort)mod.TileType("CreamIce");
							WorldGen.SquareTileFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1);
						}
						if (TileID.Sets.Conversion.Sand[type])
						{
							Main.tile[k, l].type = (ushort)mod.TileType("SugarSand");
							WorldGen.SquareTileFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1);
						}	
						if (TileID.Sets.Conversion.Grass[type])
						{
							Main.tile[k, l].type = (ushort)mod.TileType("CookieDirtTile");
							WorldGen.SquareTileFrame(k, l, true);
							NetMessage.SendTileSquare(-1, k, l, 1);
						}

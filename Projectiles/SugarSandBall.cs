...
{
	public class SugarSandBall : ModProjectile
	{
		protected bool falling = true;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Sugar Sand Ball");
		...
		public override void AI()
		{
			...
			{
				Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, mod.DustType("SugarSondDust"), projectile.velocity.X * 0.5f, projectile.velocity.Y * 0.5f);
			}
		...
		public override void Kill(int timeLeft)
		{
			if (projectile.owner == Main.myPlayer && !projectile.noDropItem)
			{
				...
				int tileType = mod.TileType("SugarSand");
